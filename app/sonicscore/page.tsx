...
export default function SonicScore() {
    return (
        <main className={styles.pageBackground + " h-full min-h-screen flex flex-col"}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-20 p-4 md:p-10 m-0 items-center">
                {/* Split the components into R, L */}
                <div className={`${styles.sonicScoreTypeset} flex flex-row gap-10 col-span-1 rounded-md p-0 order-2 sm:order-1`}>
                ...
                <div className="col-span-1 flex justify-center items-center p-4 order-1 sm:order-2">
